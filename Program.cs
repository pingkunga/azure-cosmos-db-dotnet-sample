...
const string connectionString = "AccountEndpoint=https://mslearn-262297835.documents.azure.com:443/;AccountKey=iVXMML0dFGo2vxlGu6BcXGrkWwQDkwMVmanxya8hwwKexYQb0piPNTNkHQWUFKEBFHAwWvZg5t6eACDbuorAkA==;";
...
//============================================================
Console.WriteLine("Query using LINQ expressions");

IOrderedQueryable<Product> queryable = container.GetItemLinqQueryable<Product>();
var matches = queryable.Where(p => p.Type == nameof(Product))
                       .Where(p => !p.Archived)
                       .OrderBy(p => p.Price);
